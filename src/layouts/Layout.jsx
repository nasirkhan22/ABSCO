  ...
  return (
    <div className="font-cairoRegular bg-transparent">
      ...
      >
        ...
        <div className="flex justify-between p-[30px_100px_0px_100px]">
          <ABSCO />
        ...
        {pathname === "/" ? (
          <div className="flex flex-col gap-5 p-[100px_100px_50px_100px]">
            ...
            <p className="text-[#ECECEC] text-lg">
              ...
              recognized <br /> leader in business expansion. Based in Riyadh,
              we <br /> simplify your journey into the Kingdom.
            </p>

            <div className="flex items-center gap-8">
              <Button className="primary-btn w-[260px] h-12">
                Book an Appointment
